...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    // making a list of SimplePointMarkers
	...
	private void setStyle(SimplePointMarker marker)
	{
		// set colour and size of a marker according to the earthquakes magnitude
		...
		else if(mag < THRESHOLD_MODERATE)
		{
			...
			marker.setRadius(10f);
		}
		else
		{
			marker.setColor(color(255, 0, 0));	// red
			marker.setRadius(15f);
		}
	...
	{	
		...
		textSize(12);
		text("5.0+ magnitude", 67, 116);
		text("4.0+ magnitude", 67, 176);
		text("Below 4.0", 67, 236);
		
		
		// circles
		fill(255, 0, 0);
		ellipse(45, 110, 15, 15);
		fill(255, 255, 0);
